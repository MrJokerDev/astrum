    ...
    <nav class="navbar fixed-top navbar-expand-lg">
        <div class="container">
            <div class="d-flex flex-grow-1">
                <a class="navbar-brand text-right" href="{{ route('eng.index') }}"><img src="{{ asset('images/logo.png') }}" width="100" alt=""></a>
            ...
            <div class="collapse navbar-collapse flex-grow-1 text-right" id="myNavbar7">
                <ul class="navbar-nav ms-auto flex-nowrap">
                    ...
                    {{-- <li class="nav-item">
                        <a class="nav-link" href="{{ route('eng.job') }}">Bosh ish o'rinlari</a>
                    </li> --}}
                    {{-- <li class="nav-item">
                        <a class="nav-link" href="{{ route('eng.index') }}#mentors">Mentorlar</a>
                    </li> --}}
                    <li class="nav-item">
            ...
            <div class="row pt-5">
                <div class="col-md-4">
                    ...
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('eng.fullstack') }}">
                                <div class="d-flex">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('eng.software_engineering') }}">
                                <div class="d-flex">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('eng.data_science') }}">
                                <div class="d-flex">
