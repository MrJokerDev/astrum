...
@section('content')
    <section>
        <div class="container">
            <p class="text-center p-5 text-success"><span class="fw-bold"><a href="{{ route('eng.index') }}" class="text-success text-decoration-none">HOME</a> </span> | <a href="{{ route('eng.courses') }}" class="text-success text-decoration-none">COURSES AND EDUCATION</a> | <a href="{{ route('eng.fullstack') }}" class="text-success text-decoration-none">DATA SCIENCE</a></p>
            <div class="row">
                <div class="col-md-6">
