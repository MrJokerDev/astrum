...
@section('content')
        <div id="header" class="container-lg">
            <p class="text-center p-5 text-success"><span class="fw-bold"><a href="{{ route('uz.index') }}" class="text-success text-decoration-none">BOSH SAHIFA</a> </span> | <a href="{{ route('uz.courses') }}" class="text-success text-decoration-none">KURSLAR VA TA'LIM</a> | <a href="{{ route('uz.frontend') }}" class="text-success text-decoration-none">React.js Frontend Developer</a></p>
            <div class="row">
                <div class="col-md-6">
                    <h1 class="fw-bold">React.js Frontend Developer</h1>
                    <hr class="w-25" style="border: 2px solid #62BC9E;">

                    <p id="skill" class="border border-2 rounded-2 border-dark ps-4 p-1">HTML, CSS, SCSS, Bootstrap, Git, OOP, MUI, React Bootstrap, TailwindCss, SPA, Api, TypeScript, Redux, RTK Query, Redux debugger, Redux Toolkit, Next.js, ORM, Testing, Docker</p>
                    <p>Ushbu kurs malakali veb-dasturchi bo'lish uchun to'liq qo'llanmadir. Unda React dasturchisi sifatida ishlashda bilishingiz kerak bo'lgan barcha vositalar va texnologiyalar mavjud.</p>
                </div>
                <div class="col-md-6">
            ...
            <div class="row">
                ...
                <div class="col-md-8 pt-5">
                    <div>
                        ...
                        <p>Bizning React.js Frontend Developer kursimiz o'zida 8 oydan 12 oygacha bo'lgan vaqtni qamrab oladi. Siz bu vaqt mobaynida o'zingizga o'xshagan talabalar bilan dasturlash sirlarini o'rganasiz. Undan tashqari mashg'ulotlar vaqtida funksional web saytlar va dasturlar yaratishni o'zlashtirasiz. Ushbu bilimlar esa ish topish jarayonida kerak bo'ladigan eng muhim narsalardir.</p>
                    ...
                    <div class="row mt-5">
                        ...
                        <h1 class="fw-bold mb-5">React.js Frontend Developer kursida siz quyidagilarni o'rganasiz:</h1>
                        ...
                        <div class="d-flex">
                            <i class="bi bi-check-lg me-1 mb-1 mt-1" style="font-size: 40px;"></i>
                            <p class="ms-3"><span class="fw-bold">Zamonaviy dasturlash tillari</span><br> HTML, CSS, SCSS, Bootstrap, Git, OOP, MUI, React Bootstrap, TailwindCss, SPA, Api, TypeScript, Redux, RTK Query, Redux debugger, Redux Toolkit, Next.js, ORM, Testing, Docker</p>
                        </div>
                        <hr class="fw-bold border-1">
                    ...
                    <div class="row">
                        <p style="color: #62BC9E;" class="fw-bold mt-5">React.js Frontend Developer</p>
                        ...
                        <p class="mb-5">Har hafta React.js Frontend Developer dasturchi bo'yicha o'quv kursimiz davomida sizdan turli dasturlash tillari bilan ishlash, veb-saytlar, mobil ilovalar va dasturlar yaratish bo'yicha yangi ko'nikmalarni o'rganishingiz mumkin.</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            <div class="">
                                <h1>Anvarov Baxtibek</h1>
                                <p>React.js Frontend Developer</p>
                                <hr class="w-25" style="border: 2px solid #62BC9E;">
                                <p class="">"Men React.js kutubxonasi orqali dasturlashga kirib borganman. Bu texnologiya yordamida interaktiv veb ilovalarini ishlab chiqish va ulardan oqimli foydalanishdagi tajribam kengaygan. React.js orqali foydalanuvchilar bilan ko'rsatishni osonlashtirish, ma'lumotlarni dinamik tarzda ko'rsatish va sahifalarni tezkor ishlatish borasida qimmatli yechimlar topganman. Men o'zimni o'rganish, dasturlash san'ati bo'yicha yangiliklarni kuzatish va jamoalar bilan hamkorlik qilishda qiziqishmni izohlashni yaxshi ko'raman. Mening maqsadim - React.js sohasida yetib borilganlikni izohlash va yangi dasturlash loyihalarida yaratilgan yutuqlarimni o'rganuvchilarimga ulashish. Shogirdlarimning muvaffaqiyatiga tanqidim hamisha yuqori bo'lishini xohlaman :)"</p>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4 mt-4">
                                <div class="position-relative">
                                    ...
                                    <span class="position-absolute bottom-0 start-0 p-3 text-white"><span class="fw-bold">Azizova Aziza</span> <br><span>React.js Frontend Developer</span> <hr class="w-25 m-0" style="border: 2px solid #62BC9E;"></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4 text-center">
                                <img loading="lazy" src="https://www.pngmart.com/files/23/React-Logo-PNG-Pic.png" class="w-100 h-auto m-auto" alt="image">
                            </div>
                            <div class="col-md-4 text-center">
                                <img loading="lazy" src="https://www.freepnglogos.com/uploads/javascript-png/javascript-logo-transparent-logo-javascript-images-3.png" class="w-100 h-auto m-auto" alt="image">
                            </div>
                            <div class="col-md-4 text-center">
                                <img loading="lazy" src="https://icons.veryicon.com/png/o/business/vscode-program-item-icon/typescript-def.png" class="w-100 h-auto m-auto" alt="image">
                            </div>
                        </div>
                    ...
                    <hr class="mt-5 mb-5">
                        ...
                        <div id="moon_1" class="tabcontent p-5 ps-3 pe-3 rounded">
                            <p class="fw-bold">React.js Frontend Developer</p>
                            ...
                            <div class="card_table">
                                ...
                                <p class="w-100"><span class="fw-bold">Xamidjonov komiljon</span><br> React.js Frontend Developer - Mentori</p>
                                <hr class="w-25" style="border: 2px solid #62BC9E;">
                                </div>
                                {{-- @include('front.uz.component.registerLid') --}}
                        ...
                        <div id="moon_2" class="tabcontent mt-5 p-5 ps-3 pe-3 rounded">
                            <p class="fw-bold">React.js Frontend Developerr</p>
                            ...
                            <div class="card_table">
                                <img loading="lazy" class="rounded-circle h-25 border border-warning me-3" src="{{ asset('images/python.png') }}" style="width: 6%;" alt="image">
                                <div class="d-block w-100">
                                <p class="w-100"><span class="fw-bold">Arslonova Nodira</span><br> React.js Frontend Developer - Mentori</p>
                                <hr class="w-25" style="border: 2px solid #62BC9E;">
                                </div>
                                {{-- @include('front.uz.component.registerLid') --}}
                                {{-- <a href="{{ route('uz.register') }}" class="btn btn-dark bg-dark w-100 text-white justify-content-center align-self-center">Hoziroq roʻyxatdan oʻting</a> --}}
                        ...
                        <div id="moon_3" class="tabcontent mt-5 p-5 ps-3 pe-3 rounded">
                            ...
                            <div class="card_table">
                                <img loading="lazy" class="rounded-circle h-25 border border-warning me-3" src="{{ asset('images/python.png') }}" style="width: 6%;" alt="image">
                                <div class="d-block w-100">
                                <p class="w-100"><span class="fw-bold">Alimbayeva Asal</span><br> React.js Frontend Developer - Mentori</p>
                                <hr class="w-25" style="border: 2px solid #62BC9E;">
                                </div>
                                {{-- @include('front.uz.component.registerLid') --}}
                                {{-- <a href="{{ route('uz.register') }}" class="btn btn-dark bg-dark w-100 text-white justify-content-center align-self-center">Hoziroq roʻyxatdan oʻting</a> --}}
                    ...
                    <h1>React.js Frontend Developer kursi bo'yicha savollaringiz bormi? </h1>
