...
@section('content')
    <div id="header" class="container-lg">
        <p class="text-center p-5 text-success"><span class="fw-bold"><a href="{{ route('uz.index') }}" class="text-success text-decoration-none">BOSH SAHIFA</a> </span> | <a href="{{ route('uz.courses') }}" class="text-success text-decoration-none">KURSLAR VA TA'LIM</a> | <a href="{{ route('uz.python') }}" class="text-success text-decoration-none">Python Django Backend Developer</a></p>
        <div class="row">
            <div class="col-md-6">
                <h1 class="fw-bold">Python Django Backend Developer</h1>
                <hr class="w-25" style="border: 2px solid #62BC9E;">

                <p id="skill" class="border border-2 rounded-2 border-dark ps-4 p-1">Python, MVT, Django, SOLID, PostgreSQL, ORM, SQL Server, Unit testing, RESTful, Swagger, Payme, Click, Web Socket, Docker, Docker-compose</p>
                <p>Django - bu tezkor rivojlanish va toza, pragmatik dizaynga yordam beruvchi yuqori darajadagi Python veb-ramka. Veb-ishlab chiqishdagi ko'p qiyinchiliklarni bartaraf qiladi, shuning uchun siz g'ildirakni qayta ixtiro qilmasdan ilovangizni yozishga e'tibor qaratishingiz mumkin.</p>
            </div>
            <div class="col-md-6">
            ...
            <div class="row">
                ...
                <div class="col-md-8 pt-5">
                    ...
                    <div class="row mt-5">
                        ...
                        <h1 class="fw-bold mb-5">Python Django Backend Developer kursida siz quyidagilarni o'rganasiz:</h1>
                    ...
                    <div class="row">
                        <p style="color: #62BC9E;" class="fw-bold mt-5">Python Django Backend Developer</p>
                        ...
                        <p class="mb-5">Har hafta Python Django Backend Developer dasturchi bo'yicha o'quv kursimiz davomida sizdan turli dasturlash tillari bilan ishlash, veb-saytlar, mobil ilovalar va dasturlar yaratish bo'yicha yangi ko'nikmalarni o'rganishingiz mumkin.</p>
                    ...
                    <hr class="mt-5 mb-5">
                        ...
                        <div id="moon_1" class="tabcontent p-5 ps-3 pe-3 rounded">
                            <p class="fw-bold">Python Django Backend Developer</p>
                            ...
                            <div class="card_table">
                                ...
                                <p class="w-100"><span class="fw-bold">Xamidjonov komiljon</span><br> Python Django Backend Developer - Mentori</p>
                                <hr class="w-25" style="border: 2px solid #62BC9E;">
                                </div>
                            </div>
                        </div>
                    ...
                    <h1>Python Django Backend Developer kursi bo'yicha savollaringiz bormi? </h1>
