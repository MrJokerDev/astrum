...
@section('content')
        <div id="header" class="container-lg">
            <p class="text-center p-5 text-success"><span class="fw-bold"><a href="{{ route('uz.index') }}" class="text-success text-decoration-none">BOSH SAHIFA</a> </span> | <a href="{{ route('uz.courses') }}" class="text-success text-decoration-none">KURSLAR VA TA'LIM</a> | <a href="{{ route('uz.3dmax') }}" class="text-success text-decoration-none">3Ds Max & Interior Design</a></p>
            <div class="row">
                <div class="col-md-6">
            ...
            <div class="row">
                ...
                <div class="col-md-8 pt-5">
                    ...
                    <div class="row mt-5">
                        ...
                        <h1 class="fw-bold mb-5">Data Science kursida siz quyidagilarni o'rganasiz:</h1>
                    ...
                    <div class="row">
                        ...
                        <p class="mb-5">Har hafta Data Science dasturchi bo'yicha o'quv kursimiz davomida sizdan turli dasturlash tillari bilan ishlash, veb-saytlar, mobil ilovalar va dasturlar yaratish bo'yicha yangi ko'nikmalarni o'rganishingiz mumkin.</p>
                    ...
                    <h1>Data Science kursi bo'yicha savollaringiz bormi? </h1>
