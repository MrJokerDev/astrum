...
@section('content')
        <div id="header" class="container-lg">
            <p class="text-center p-5 text-success"><span class="fw-bold"><a href="{{ route('uz.index') }}" class="text-success text-decoration-none">BOSH SAHIFA</a> </span> | <a href="{{ route('uz.courses') }}" class="text-success text-decoration-none">KURSLAR VA TA'LIM</a> | <a href="{{ route('uz.csharp') }}" class="text-success text-decoration-none">C# .Net Backend Developer</a></p>
            <div class="row">
                <div class="col-md-6">
                    <h1 class="fw-bold">C# .Net Backend Developer</h1>
                    <hr class="w-25" style="border: 2px solid #62BC9E;">

                    <p id="skill" class="border border-2 rounded-2 border-dark ps-4 p-1">C#, OOP, .NET, NUGET, ASP.NET, RESTFul, SOLID, Swagger, PostgreSQL, ORM, SQL Server, Payme, Paypal, Docker, Docker-compose, Microservices, Web Socket, End to End testing, Unit testing</p>
                    <p>Microsoft .NET dasturiy platformasidan foydalangan holda C# dasturlash tilida mustahkam va xavfsiz veb-ilovalarni yarating.</p>
            ...
            <div class="row">
                ...
                <div class="col-md-8 pt-5">
                    ...
                    <div class="row mt-5">
                        ...
                        <h1 class="fw-bold mb-5">C# .Net Backend Developer kursida siz quyidagilarni o'rganasiz:</h1>
                    ...
                    <div class="row">
                        <p style="color: #62BC9E;" class="fw-bold mt-5">C# .Net Backend Developer</p>
                        ...
                        <p class="mb-5">Har hafta C# .Net Backend Developer dasturchi bo'yicha o'quv kursimiz davomida sizdan turli dasturlash tillari bilan ishlash, veb-saytlar, mobil ilovalar va dasturlar yaratish bo'yicha yangi ko'nikmalarni o'rganishingiz mumkin.</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            <div class="">
                                ...
                                <hr class="w-25" style="border: 2px solid #62BC9E;">
                                <p class="">"Salom mening ismim Sarvar! Men C# .NET backend dasturlash tillarida ko'p yillik tajriba egan dasturchiman. Men sun'iy intellekt, ma'lumotlar tahlili va backend injenering sohalarida amaliyotda ishlashim bor. Biznes jarayonlarini avtomatlashtirish va ma'lumotlar analizi asosida foydali yechimlar taklif etishim sizga qiziqroq bo'ladi."</p>
                            </div>
                        </div>
                        <hr class="mt-5 mb-5">
                        ...
                        <div class="row">
                            <div class="col-md-4 text-center">
                                <img loading="lazy" src="https://seeklogo.com/images/C/c-sharp-c-logo-02F17714BA-seeklogo.com.png" class="w-100 h-auto m-auto" alt="image">
                            </div>
                            <div class="col-md-4 text-center">
                                <img loading="lazy" src="https://technostacks.com/wp-content/uploads/2021/01/aspnet_logo.png" class="w-100 h-auto m-auto" alt="image">
                            </div>
                            <div class="col-md-4 text-center">
                                <img loading="lazy" src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/ee/.NET_Core_Logo.svg/1024px-.NET_Core_Logo.svg.png" class="w-100 h-auto m-auto" alt="image">
                            </div>
                        </div>
...
{{--                        <p class="fw-bold mt-5">30 августа 2022 - 03 ноября 2023 </p>--}}
                        ...
                        <div id="moon_1" class="tabcontent p-5 ps-3 pe-3 rounded">
                            <p class="fw-bold">C# .Net Backend Developer</p>
                            ...
                            <div class="card_table">
                                ...
                                <p class="w-100"><span class="fw-bold">Ozodov Sarvar</span><br>C# .Net Backend Developer - Mentori</p>
                                <hr class="w-25" style="border: 2px solid #62BC9E;">
                                </div>
                                {{-- @include('front.uz.component.registerLid') --}}
                    ...
                    <h1>C# .Net Backend Developer kursi bo'yicha savollaringiz bormi? </h1>
