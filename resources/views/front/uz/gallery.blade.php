...
@section('content')
    ...
    <section>
        <div class="container">
            ...
            <div class="row pb-5">
                <div class="col-md-8">
                    <a href="{{ asset('{{ asset('images/DSC03614.JPG')}}')}}" style="text-decoration: none;">
                        <div id="container" class="hvr-float">
                            <img
                                src="{{ asset('{{ asset('images/DSC03614.JPG')}}')}}"
            ...
            <div class="row pb-5">
                <div class="col-md-6">
                    <a href="{{ asset('images/DSC03268.JPG')}}" style="text-decoration: none;">
                        <div id="container" class="hvr-float">
                            <img
                                src="{{ asset('images/DSC03268.JPG')}}"
