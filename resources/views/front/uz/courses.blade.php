            ...
            <div class="row h-100">
                <div class="col-md-7 align-self-end mb-5">
                    <div class="text-white">
                        <p class="text-success"><span class="fw-bold"><a href="{{ route('uz.index') }}" class="text-decoration-none text-success">ГЛАВНАЯ</a></span> | <a href="{{ route('uz.courses') }}" class="text-decoration-none text-success">КУРСЫ И ОБРАЗОВАНИЕ</a></p>
