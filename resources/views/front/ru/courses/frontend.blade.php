...
@section('content')
        <div id="header" class="container">
            <p class="text-center p-5 text-success"><span class="fw-bold"><a href="{{ route('ru.index') }}" class="text-success text-decoration-none">ГЛАВНАЯ</a> </span> | <a href="{{ route('ru.courses') }}" class="text-success text-decoration-none">КУРСЫ И ОБРАЗОВАНИЕ</a> | <a href="{{ route('ru.fullstack') }}" class="text-success text-decoration-none">DATA SCIENCE</a></p>
            <div class="row">
                <div class="col-md-6">
            ...
            <div class="row">
                <div class="col-md-4">
                    <nav id="navbar-bg" class="navbar sticky-top rounded p-4">
                        <ul class ="nav navbar-nav w-100">
                            ...
                            <li class ="nav-item">
                                <a class ="nav-link fw-bold" href="#Менторs">Менторы</a>
                            </li>
                            <li class ="nav-item">
                ...
                <div class="col-md-8 pt-5">
                    <div>
                        ...
                        <p>Наш курс Data Science проходит от 8 до 12 месяцев. За это время, со студентами похожими на вас вы узнаете секреты программирования. Кроме того, во время занятий вы освоите создание функциональных веб-сайтов и программ . И эти знания станут самыми важными факторами в процессе поиска работы.</p>
                    ...
                    <div class="row mt-5">
                        ...
                        <h1 class="fw-bold mb-5">В курсе Data Science вы освоите:</h1>
                    ...
                    <div class="row">
                        ...
                        <p class="mb-5">Каждую неделю во время нашего учебного курса для разработчиков Data Science вы можете освоить новые навыки работы с различными языками программирования, создания веб-сайтов, мобильных приложений и программ.</p>
                    ...
                    <hr class="mt-5 mb-5">
                    <div class="row">
                        <p id="Менторs" style="color: #62BC9E;" class="fw-bold mt-5">КОМАНДА МЕНТОРОВ</p>
