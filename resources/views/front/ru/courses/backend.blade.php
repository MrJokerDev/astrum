...
@section('content')
        <div id="header" class="container-lg">
            <p class="text-center p-5 text-success"><span class="fw-bold"><a href="{{ route('ru.index') }}" class="text-success text-decoration-none">Главная</a> </span> | <a href="{{ route('ru.courses') }}" class="text-success text-decoration-none">Курсы и образование</a> | <a href="{{ route('ru.backend') }}" class="text-success text-decoration-none">{{$course->title}}</a></p>
            <div class="row">
                <div class="col-md-6">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div>
                        ...
                        <p>Наш курс {{$course->title}} проходит от 8 до 12 месяцев. За это время, со студентами похожими на вас вы узнаете секреты программирования. Кроме того, во время занятий вы освоите создание функциональных веб-сайтов и программ . И эти знания станут самыми важными факторами в процессе поиска работы.</p>
                    ...
                    <div class="row mt-5">
                        ...
                        <h1 class="fw-bold mb-5">В курсе разработчика {{$course->title}} вы освоите:</h1>
...
{{--                        </div>--}}
                    ...
                    <h1>Есть вопросы по курсу {{$course->title}}?</h1>
