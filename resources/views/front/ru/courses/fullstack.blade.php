...
@section('content')
    <section>
        <div class="container">
            <p class="text-center p-5 text-success"><span class="fw-bold"><a href="{{ route('ru.index') }}" class="text-success text-decoration-none">Главная</a> </span> | <a href="{{ route('ru.courses') }}" class="text-success text-decoration-none">Курсы и образование</a> | <a href="{{ route('ru.fullstack') }}" class="text-success text-decoration-none">Full Stack Developer</a></p>
            <div class="row">
                <div class="col-md-6">
                    ...
                    <hr class="mt-5 mb-5">
                        ...
                        <div id="moon_1" class="tabcontent p-5 ps-3 pe-3 rounded">
                            ...
                            <div class="card_table">
                                ...
                                <a href="{{ route('ru.register') }}" class="btn btn-dark bg-dark w-100 text-white">Зарегистрируйтесь сейчас</a>
                            </div>
                        </div>
                ...
                <div class="col-xxl-6 col-xl-6 col-sm-6 col-md-6">
                    <div class="card hvr-float m-auto mt-3" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <a id="btn" href="{{ route('ru.software_engineering') }}" class="btn btn-outline-success p-3 rounded">Batafsil</a>
                        </div>
                    </div>
                </div>
                <div class="col-xxl-6 col-xl-6 col-sm-6 col-md-6">
                    <div class="card hvr-float m-auto mt-3" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            {{-- <p class="fs-5">12 oy</p> --}}
                            <hr class="w-25 border border-success border-2">
                            <a id="btn" href="{{ route('ru.data_science') }}" class="btn btn-outline-success p-3 rounded">Batafsil</a>
                        </div>
                    </div>
                </div>
            </div>
