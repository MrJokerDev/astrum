...
@section('content')
    <section>
        <div class="container">
            <p class="text-center p-5 text-success"><span class="fw-bold"><a href="{{ route('ru.index') }}" class="text-success text-decoration-none">ГЛАВНАЯ</a> </span> | <a href="{{ route('ru.courses') }}" class="text-success text-decoration-none">КУРСЫ И ОБРАЗОВАНИЕ</a> | <a href="" class="text-success text-decoration-none">FULL STACK DEVELOPER</a></p>
            <div class="row">
                <div class="col-md-6">
