...
@section('content')
    ...
    <section class="text-center mt-5 pt-5">
        <p><span class="fw-bold"><a href="{{ route('ru.index') }}" class="text-success text-decoration-none">Главная</a></span> | <a href="{{ route('ru.news') }}" class="text-success text-decoration-none">новости</a> | <a href="{{ route('ru.news_pages') }}" class="text-success text-decoration-none">Обучение и перспективы</a></p>
