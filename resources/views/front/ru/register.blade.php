	...
	<div class="contact1">
		<div class="container-contact1">
			...
			<form action="{{ route('create.user') }}" method="POST" class="contact1-form validate-form">
				...
				<div class="wrap-input1 validate-input" data-validate="Требуется имя">
					<input class="input1" type="text" name="first_name" placeholder="Имя">
					<span class="shadow-input1"></span>
				</div>

				<div class="wrap-input1 validate-input" data-validate="Требуется фамилия">
					<input class="input1" type="text" name="last_name" placeholder="Фамилия">
					<span class="shadow-input1"></span>
				</div>

				<div class="wrap-input1 validate-input" data-validate="Требуется действующий адрес электронной почты: astrum@mail.uz">
					<input class="input1" type="text" name="email" placeholder="Электронная почта">
					<span class="shadow-input1"></span>
				</div>

				<div class="wrap-input1 validate-input" data-validate="Укажите номер телефона.">
					<input class="input1" type="number" name="phone" placeholder="998 71 202 42 22">
					<span class="shadow-input1"></span>
				</div>
