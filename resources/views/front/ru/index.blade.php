            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        <h1 class="text-home ms-0 text-start w-50 pb-5">Astrum IT Academy предлагает вам отличную возможность. Приветствуем у нас начались процессы приема в Pre Season 7.</h1>
                        <h1 class="ms-0 text-start mb-5 pb-5">
                            <a href="{{ route('ru.register') }}" class="btn btn-success p-3">Зарегистрируйтесь сейчас</a>
                        </h1>
                    </div>
                </div>
