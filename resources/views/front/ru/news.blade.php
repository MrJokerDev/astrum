...
@section('content')
    ...
    <div class="img-fon position-relative">
        ...
        <div class="position-absolute bottom-0 start-25 translate-middle">
            <p class="text-white"><span><a class="text-white text-decoration-none fw-bold" href="{{ route('ru.index') }}">Главная</a></span> | <a class="text-white text-decoration-none" href="{{ route('ru.courses') }}">курсы и образование</a></p>
                ...
                <div class="col-xxl-3 col-lg-4 col-md-6 col-12">
                    <div class="card hvr-float m-auto" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{ route('ru.news_pages') }}" class="href_arrow">Читатть <i class="bi bi-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-xxl-3 col-lg-4 col-md-6 col-12">
